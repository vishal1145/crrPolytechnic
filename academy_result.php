...
<?php
    ...
    <div class="container height">
        <div class="col-md-3">
            <div class="leftSide">
               <h3 class="module_title">Result</h3>
               <div class="mod-menu">
                <ul class="nav">
                   <li>
                        <a href="">
       ...
       <div class="col-md-9">
        <div class="rightside">
        <h3 class="item_title">The students can check their result using below link.</h3>
         <div class="newClass"   style="padding-top:3px;">
                <h3>
                    <a href="https://sbtet.ap.gov.in/APSBTET/results.do">See Result</a>
                </h3>
         </div>
        </div>
     </div>
